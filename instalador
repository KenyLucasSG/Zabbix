# Script de instalação fácil Zabbix 6 e MySQL 8 em Debian 11
...
# Versão 8.0 do MySQL
MYSQL_VERSION=8.0
MYSQL_PASSWD=Zabbix@Senha2025 # ALTERE ESSA SENHA DO ROOT!!
ZABBIX_PASSWD=Zabbix@Senha2025 # ALTERE ESSA SENHA DO USUÁRIO ZABBIX!!
